...
import { logout, showTripDetails, goToPreviousPage } from '../../routers/Coordinator'
...
function TripDetailsPage() {
  ...
  return (
    <ContainerTripDetailsPage>
      <Header redirectPage={() => goToPreviousPage(history)}
        titleRedirect={"Voltar"}
        titleSecondary={"Logout"}
        redirectPageSecondary={() => logout(history)} />
      <Main>
        <TitlePrincipal>
          <h1>Lista Viagens</h1>
        </TitlePrincipal>
